...
if (!empty($_SESSION['login']) && $_SESSION['role'] == 'super-admin') { ?>
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo $base ?>admin/employee/update.php" method="POST">
                    <div class="row">
                        <div class="col-lg-6">
                            <input type="hidden" name="emp_id" value="<?php echo $id ?>">
                            <div class="mb-3">
                                <label for="username" class="form-label">Employee Username</label>
                                <input type="text" class="form-control" name="username" value="<?php if (!empty($employees)) {
                                                                                                    echo $employees['username'];
                                                                                                } ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="emp_name" value="<?php if (!empty($employees)) {
                                                                                                    echo $employees['emp_name'];
                                                                                                } ?>">
                                <div class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="emp_department" class="form-control">
                                    ...
                                    <?php foreach ($deps as $dep) { ?>
                                        ...
                                        <option <?php if (!empty($employees) && $dep['id'] == $employees['emp_department']) { ?> <?php
                                                                                                                                    echo "selected";
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="emp_email" value="<?php if (!empty($employees)) {
                                                                                                    echo $employees['emp_email'];
                                                                                                } ?>">
                                <div class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" name="emp_phone" value="<?php if (!empty($employees)) {
                                                                                                    echo $employees['emp_phone'];
                                                                                                } ?>">
                                <div class="form-text"></div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="emp_address" value="<?php if (!empty($employees)) {
                                                                                                        echo $employees['emp_address'];
                                                                                                    } ?>">
                                <div class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="zip_code" value="<?php if (!empty($employees)) {
                                                                                                    echo $employees['zip_code'];
                                                                                                } ?>">
                                <div class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="blood_group" value="<?php if (!empty($employees)) {
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="dob" value="<?php if (!empty($employees)) {
                                                                                                echo $employees['dob'];
                                                                                            } ?>">
                                <div class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="role" class="form-control">
                                    ...
                                    <?php foreach ($roles as $role) { ?>
                                        <option <?php if (!empty($employees) && $role['role_name'] == $employees['role']) { ?> <?php
                                                                                                                                echo "selected";
