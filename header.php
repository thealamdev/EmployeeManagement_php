...
if (!isset($_SESSION)) {
    session_start();
    // database page referance:
    // $page_name = $uri[4];
    // $active_page =  explode('.', $page_name);
}
...
?>
    ...
    <head>
        ...
        <link type="text/css" href="backend/vendor/perfect-scrollbar.css" rel="stylesheet">
        <link type="text/css" href="<?= $base ?>/backend/css/app.css" rel="stylesheet">
        <link rel="stylesheet" href="<?= $base ?>/backend/css/vendor-material-icons.css">
        <link type="text/css" href="<?= $base ?>/backend/css/vendor-material-icons.css" rel="stylesheet">
        <link type="text/css" href="<?= $base ?>/backend/css/vendor-fontawesome-free.css" rel="stylesheet">
        <link type="text/css" href="<?= $base ?>/backend/css/vendor-flatpickr.css" rel="stylesheet">
        <link type="text/css" href="<?= $base ?>/backend/css/vendor-flatpickr-airbnb.css" rel="stylesheet">
        <link rel="stylesheet" href="https://maxst.icons8.com/vue-static/landings/line-awesome/line-awesome/1.3.0/css/line-awesome.min.css">
        <link type="text/css" href="<?= $base ?>/backend/css/toastr.min.css" rel="stylesheet">
        <link rel="stylesheet" href="https://maxst.icons8.com/vue-static/landings/line-awesome/line-awesome/1.3.0/css/line-awesome.min.css">
    </head>
                                        ...
                                        <div class="navbar-notifications-menu__content" data-perfect-scrollbar>
                                            <div class="py-2">
                                                ...
                                                <div class="dropdown-item d-flex">
                                                    <div class="mr-3">
                                                        <div class="avatar avatar-sm" style="width: 32px; height: 32px;">
                                                            <img src="{{ asset('backend/images/256_daniel-gaffey-1060698-unsplash.jpg') }}" alt="Avatar" class="avatar-img rounded-circle">
                                                        </div>
                                                    </div>
                                                    <div class="flex">
                                                        <a href="">A.Demian</a> left a comment on <a href="">FlowDash</a><br>
                                ...
                                <li class="nav-item dropdown">
                                    <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light"><?php if (!empty($_SESSION['name'])) {
                                                                            echo $_SESSION['name'];
                                                                        } ?></span>
                                        </span>
                                    ...
                                    <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="<?= $base ?>admin/logout/logout.php"><i class="material-icons">exit_to_app</i>Logout</a>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="page__heading d-flex align-items-end">
                                <div class="flex">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <!-- <li class="breadcrumb-item"> <?php echo $uri[2] ?></li>
                                            <li class="breadcrumb-item active" aria-current="page"><?php echo $uri[3] ?></li>
                                            <li class="breadcrumb-item active" aria-current="page"><?php echo $active_page[0] ?></li> -->
                                        </ol>
                                    </nav>
                                    <h1 class="m-0"></h1>
                                </div>
                                <div class="flatpickr-wrapper ml-3">
                                    <div id="recent_orders_date" data-toggle="flatpickr" data-flatpickr-wrap="true" data-flatpickr-mode="range" data-flatpickr-alt-format="d/m/Y" data-flatpickr-date-format="d/m/Y">
                                        <a href="javascript:void(0)" class="link-date" data-toggle><?php echo date('Y-m-d h:i a') ?></a>
